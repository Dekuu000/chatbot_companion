  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-2">
        <h1 className="text-4xl font-bold text-text-primary">Complete Your Profile</h1>
        <p className="text-text-secondary">Whether you're studying or already working, tell us about your background so we can tailor advice.</p>
      </div>

...
export default function ChatPage() {
  ...
  return (
    <div className="h-full flex flex-col bg-bg">
      ...
      {/* Input Area */}
      <div className={cn(
        "fixed inset-x-0 bottom-0 z-20 border-t border-border bg-gradient-to-b from-bg via-bg/95 to-bg/85 backdrop-blur-md",
        isAuthenticated && "md:left-64 lg:left-72"
      )}>
